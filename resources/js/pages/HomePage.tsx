...
export default function HomePage() {
  const { username,likes,comments, verification, selectAct, lastName, club, studentId, selectedAct, projects, activeStaffs, getPostedData, students, notifications, admin, team, studentPost, usernameP } =
    usePage().props as unknown as {
      ...
      getPostedData: {id:number,likes:number; name:string, picture:string; caption:string; created_at:string; club:string;userid:number}[],
  ...
  return (
    <div>
      <UserHomeTab likes={likes} usernameP={usernameP}
