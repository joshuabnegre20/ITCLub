...
export default function AdminView() {
  ...
  const { projectList , user_id, lastName ,totalUsers, totalStaffs, username, users, totalActives, verifiedUsers, activities,sentActivities, joinedProject } = usePage().props as unknown as {
    totalUsers: number;
    totalStaffs: number;
    username: string;
    totalActives: number;
    ...
    sentActivities : {id: number; student_id: number ;activity_id: number; name: string; club:string; links: string; status: string}[];
    lastName: string;
    user_id: number;
  ...
  return (
    <div>
      <SideBar joinedProject ={joinedProject} projectList ={projectList} user_id={user_id} lastName={lastName} sentActivities ={sentActivities} activities ={activities} verifiedUsers= {verifiedUsers} totalActives= {totalActives} username= {username} totalUsers={totalUsers} totalStaffs={totalStaffs} users = {users} />
    </div>
  );
}
